...
public class BradescoParserTests
{
    ...
    private static string BuildHeaderLine()
    {
        ...
        SetField(chars, 77, 18, "EMPRESA BRADESCO");
    ...
    private static string BuildDetalheLine()
    {
        ...
        SetField(chars, 58, 15, "123456789012345");
