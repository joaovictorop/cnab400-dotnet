...
public class ItauCnab400Parser : Cnab400ParserBase, ICnab400Parser
{
    ...
    private HeaderRemessa ParseHeader(string line)
    {
        ...
        {
            CodigoBanco = ExtractInt(line, 2, 3),
            NomeEmpresa = ExtractString(line, 27, 20),
    ...
    private DetalheRemessa ParseDetalhe(string line)
    {
        ...
        {
            NossoNumero = ExtractString(line, 70, 12),
